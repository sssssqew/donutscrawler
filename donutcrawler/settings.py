"""
Django settings for donutcrawler project.
...
SECRET_KEY = 'npxzz7r-l$ysgz4#(195z8q1!f!@w5eah_^cj)j(kre2rw*w(n'
...
ROOT_URLCONF = 'donutcrawler.urls'
...
WSGI_APPLICATION = 'donutcrawler.wsgi.application'
